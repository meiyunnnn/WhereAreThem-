...
public class FirstPersonController : MonoBehaviour
{
    ...
    [SerializeField] Transform head;   // จุดหัวของโมเดล
    [SerializeField] Transform body;   // จุดลำตัว (Root)
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            if (animator != null)
            {
                animator.SetBool("isWalking", isWalking);   // ใช้กับ Idle/Walk
                animator.SetBool("isSprinting", isSprinting); // ถ้ามี Sprint animation
            }
